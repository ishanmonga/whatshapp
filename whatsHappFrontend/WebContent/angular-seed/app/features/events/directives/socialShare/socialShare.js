...
.run([
      '$rootScope', function ($rootScope) {
          $rootScope.facebookAppId = '1111926468936986]'; // set your facebook app id here
      }
  ])
.controller('SocialShareCtrl', function ($scope) {
	   $scope.myModel = {
	              Url: 'http://localhost:8080/whatsHappFrontend/index.html#!/event/category/3',
...
.directive('whSocialShare', function() {
	  return {
		  scope : {
			...
			controllerAs : 'ctrl',
			templateUrl : 'angular-seed/app/features/events/directives/socialShare/socialShare.html'
		  };
	});